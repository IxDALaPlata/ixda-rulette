...
function drawRouletteWheel() {
  ...
  if (canvas.getContext) {
    ...
    ctx.fillStyle = "black";
    ctx.beginPath();
    // ctx.moveTo(10 - 4, 650 - (outsideRadius + 5));
    // ctx.lineTo(10 + 4, 650 - (outsideRadius + 5));
    // ctx.lineTo(10 + 4, 650 - (outsideRadius - 5));
    // ctx.lineTo(10 + 9, 650 - (outsideRadius - 5));
    // ctx.lineTo(10 + 0, 650 - (outsideRadius - 13));
    // ctx.lineTo(10 - 9, 650 - (outsideRadius - 5));
    // ctx.lineTo(10 - 4, 650 - (outsideRadius - 5));
    // ctx.lineTo(10 - 4, 650 - (outsideRadius + 5));

    ctx.moveTo(outsideRadius + insideRadius - (outsideRadius + 5), outsideRadius + insideRadius - 4);
    ctx.lineTo(outsideRadius + insideRadius - (outsideRadius + 5), outsideRadius + insideRadius + 4);
    ctx.lineTo(outsideRadius + insideRadius - (outsideRadius - 5), outsideRadius + insideRadius + 4);
    ctx.lineTo(outsideRadius + insideRadius - (outsideRadius - 5), outsideRadius + insideRadius + 9);
    ctx.lineTo(outsideRadius + insideRadius - (outsideRadius - 13),outsideRadius + insideRadius + 0);
    ctx.lineTo(outsideRadius + insideRadius - (outsideRadius - 5), outsideRadius + insideRadius - 9);
    ctx.lineTo(outsideRadius + insideRadius - (outsideRadius - 5), outsideRadius + insideRadius - 4);
    ctx.lineTo(outsideRadius + insideRadius - (outsideRadius + 5), outsideRadius + insideRadius - 4);
    ctx.fill();
